...
<li> toujours dans la class Joke, créer un state qui aura la key ```joke: ""```</li>

<li>revient dans le ComponentDidMount, et en dessous de la constante, fait un ```setState``` sur joke, et donne lui maintenant la valeur ```getRandomJoke.body```
